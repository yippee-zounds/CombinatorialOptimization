...
namespace CombinatorialOptimization
{
    ...
    class ReactiveRandomLocalSearch66 : IOptimizationAlgorithm
    {
        ...
        public ReactiveRandomLocalSearch66(long limit, double targetHighAct, double targetLowAct, int targetRange)
        {
            this.limit = limit;
