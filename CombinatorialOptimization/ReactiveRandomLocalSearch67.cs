...
namespace CombinatorialOptimization
{
    ...
    class ReactiveRandomLocalSearch67 : IOptimizationAlgorithm
    {
        ...
        public ISolution Solve(IOptimizationProblem p, ISolution sol, DataStoringWriter w)
        {
            ...
            int bestLoop = 0;
            double startRatio = 0.9;// targetHighAct;
            ...
            for (int loop = 0; true; loop++)
            {
                ...
                if (loop < 20000 && targetHighAct <= targetAct)
                {
                    if ((loop + 1) % 2500 == 0)
                    {
                        targetAct -= 0.05;
        ...
        public ReactiveRandomLocalSearch67(long limit, double targetHighAct, double targetLowAct, int targetRange)
        {
            this.limit = limit;
