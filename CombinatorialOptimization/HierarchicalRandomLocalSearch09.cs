...
namespace CombinatorialOptimization
{
    ...
    class HierarchicalRandomLocalSearch09 : IOptimizationAlgorithm
    {
        private long limit;
        private int trj;
        ...
        public HierarchicalRandomLocalSearch09(long limit, int trj, double targetHighAct, double targetMidAct, double targetLowAct, int range)
        {
            this.limit = limit;
            this.trj = trj;
