...
namespace CombinatorialOptimization
{
    ...
    class HierarchicalRandomLocalSearch0A : IOptimizationAlgorithm
    {
        private long limit;
        private int trj;
        ...
        public ISolution Solve(IOptimizationProblem p, ISolution sol, DataStoringWriter w)
        {
            ...
            w.WriteLine("loop:vbest:vhigh:vmid:vlow:nhigh:nmid:nlow:lowin:lowex:midin:midex:dm:lta:x");
            ...
            for (int loop = 1; true; loop++)
            {
                ...
                w.WriteLine(loop + ":" + ret.Value + ":" + root.s.Value
                    ...
                    + ":" + lowIn + ":" + lowEx + ":" + midIn + ":" + midEx + ":" + (dm == null ? 0 : dm.DiameterValue) + ":" + lta + ":" + ret);
        ...
        public HierarchicalRandomLocalSearch0A(long limit, int trj, double targetHighAct, double targetMidAct, double targetLowAct, int range)
        {
            this.limit = limit;
            this.trj = trj;
