...
namespace CombinatorialOptimization
{
    ...
    class ReactiveRandomLocalSearch6 : IOptimizationAlgorithm
    {
        ...
        public ReactiveRandomLocalSearch6(long limit, double targetHighAct, double targetLowAct, int targetRange)
        {
            this.limit = limit;
