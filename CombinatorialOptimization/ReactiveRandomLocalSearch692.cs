...
namespace CombinatorialOptimization
{
    ...
    class ReactiveRandomLocalSearch692 : IOptimizationAlgorithm
    {
        ...
        public ReactiveRandomLocalSearch692(long limit, double targetHighAct, double targetLowAct, int targetRange)
        {
            this.limit = limit;
