...
namespace CombinatorialOptimization
{
    ...
    class ReactiveRandomLocalSearch6B : IOptimizationAlgorithm
    {
        ...
        public ReactiveRandomLocalSearch6B(long limit, double targetHighAct, double targetLowAct, int targetRange)
        {
            this.limit = limit;
