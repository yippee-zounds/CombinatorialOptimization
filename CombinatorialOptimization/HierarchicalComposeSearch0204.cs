...
{
    class HierarchicalComposeSearch0204 : IOptimizationAlgorithm
    {
        private long limit;
        private int ctrj;
        private int dtrj;
        ...
        public HierarchicalComposeSearch0204(long limit, int ctrj, int dtrj, double targetHighAct, double targetMidAct, double targetLowAct, int range)
        {
            this.limit = limit;
            this.ctrj = ctrj;
            this.dtrj = dtrj;
